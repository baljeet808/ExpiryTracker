    ...
    fun getImages(): ArrayList<Image> {
        ...
        images.add(
            Image(
                ...
                "bell_pepper",
                "bell_yellow_pepper",
                "Bell yellow pepper", mimeType = "asset",
                uri = Uri.parse(""),
                bitmap = ""
            )
        )
        ...
        images.add(
            Image(
                ...
                "green_chili_pepper",
                "green_chilli_pepper",
                "green_chilli_pepper", mimeType = "asset",
                uri = Uri.parse(""),
                bitmap = ""
            )
        )
        ...
        images.add(
            Image(
                ...
                "pomegranate_two",
                "pomegranate_two",
                "pomegranate_two", mimeType = "asset",
                uri = Uri.parse(""),
                bitmap = ""
            )
        )
